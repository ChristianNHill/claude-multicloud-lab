...
Add to `.env`. The credentials have to be *present* — the SDKs won't construct a client without them — but they're never checked, so any string works.
